...
// import matchTheEvents from './MobileDay'
...
// // matchTheEvents(eventNameArr, currentYear, currentMonth, day, events, summaries);
...
//     it('should render', ()=>{
//         const wrapper = shallow(<Day key={0} i={0} isPicked={false} handleSelected={handleSelected} isToday={false} day={25} date={date} events={events} eventNameArr={eventNameArr} summaries={summaries}/>)
//         matchTheEvents(eventNameArr, 2020, 3, 25, summaries);
